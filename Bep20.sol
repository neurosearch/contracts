...
function add(uint256 a, uint256 b) internal pure returns (uint256) { uint256 c = a + b; require(c >= a, "SafeMath: addition overflow");
...
constructor() public { _name = "BNB.Energy"; //CHANGEME _symbol = "BNBEN"; //CHANGEME _decimals = 18; _totalSupply = 120000000000000000000000000; //1,000,000 Tokens _balances[msg.sender] = _totalSupply;
